...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get readLaterTitle => 'بعد میں پڑھیں';

  @override
  String get favouriteTooltip => 'پسندیدہ';

  @override
  String get removeFromReadLaterTooltip => 'بعد میں پڑھیں سے ہٹائیں';

  @override
  String get noBooksToReadLater => 'بعد میں پڑھنے کے لیے کوئی کتاب نہیں';

  @override
  String get addBooksToReadLaterHint =>
      'میری کتابیں اسکرین سے کتابیں بعد میں پڑھنے کے لیے شامل کریں';

  @override
  String get completedBooksTitle => 'مکمل کتابیں';

  @override
  String get completedStatusLabel => 'مکمل';

  @override
  String get noCompletedBooksYet => 'ابھی تک کوئی مکمل کتاب نہیں';

  @override
  String get completedBooksHint => 'آپ کی پڑھی ہوئی کتابیں یہاں دکھائی دیں گی';
  ...
  @override
  String get aboutBio =>
      'ایک Flutter ڈویلپر جو خوبصورت اور فعال ایپلیکیشنز بنانے کا جذبہ رکھتا ہے۔ یہ ایپ Flutter اور Firebase کے ساتھ مقامی ڈیٹا اسٹوریج کا استعمال کرتے ہوئے بنائی گئی ہے، جو موبائل ڈویلپمنٹ میں مہارت ظاہر کرتی ہے۔';
